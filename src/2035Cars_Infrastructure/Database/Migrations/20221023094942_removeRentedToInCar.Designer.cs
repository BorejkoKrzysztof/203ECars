...
namespace _2035Cars_Infrastructure.Database.Migrations
{
    ...
    [Migration("20221023094942_removeRentedToInCar")]
    partial class removeRentedToInCar
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("_2035Cars_Core.Domain.ContactMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("_2035Cars_Core.Domain.Order", b =>
                {
                    ...
                    b.Property<Guid>("UniqueOrderNumber")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("_2035Cars_Core.Domain.Order", b =>
                {
                    ...
                    b.HasOne("_2035Cars_Core.Domain.Client", "Client")
                        .WithMany("Orders")
                        .HasForeignKey("ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
