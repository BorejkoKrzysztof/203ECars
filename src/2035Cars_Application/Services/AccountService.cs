...
//     {
//         var account = await this._repository.GetByEmailAsync(emailAddress);
//         if (account is null)
//         {
...
//         string refreshToken = await this._repository.GetRefreshTokenAsync(account.Id);
//         if (refreshToken is null)
//         {
//              refreshToken = await this._repository.CreateRefreshTokenAsync(account.Id);
//         }
...
//         string refreshToken = await _repository.GetRefreshTokenAsync(account.Id);

//         if (refreshToken is null)
//         {
//             refreshToken = await _repository.CreateRefreshTokenAsync(account.Id);
//         }
